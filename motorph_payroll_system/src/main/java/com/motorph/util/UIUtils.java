...
/**
 * Utility class for creating styled UI components that match the prototype
 * design.
 */
public class UIUtils {
    ...
    public static JButton createSecondaryButton(String text) {
        return createStyledButton(text, UIConstants.SECONDARY_BUTTON_COLOR, UIConstants.BUTTON_TEXT_COLOR);
    }
